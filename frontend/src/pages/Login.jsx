          ...
          <form onSubmit={handleSubmit} className="space-y-4" autoComplete="on">
            ...
            <div className="flex items-center justify-between">
              <label className="flex items-center gap-2 cursor-pointer select-none">
                ...
                />
                <span className="text-sm text-gray-500">Ghi nho tai khoan</span>
              </label>
              <button
                type="button"
          ...
          <div className="bg-white rounded-2xl shadow-xl w-full max-w-sm p-6">
            <div className="flex items-center justify-between mb-4">
              <div className="flex items-center gap-2">
                ...
                <h3 className="font-bold text-gray-800">Quen mat khau</h3>
              </div>
            ...
            <p className="text-sm text-gray-500 mb-5 leading-relaxed">
              Vui long lien he <strong className="text-gray-700">Quan tri vien</strong> de duoc reset mat khau.
            </p>
            <div className="bg-blue-50 rounded-xl p-4 space-y-2.5">
              ...
              <div className="flex items-center gap-3">
                ...
                <span className="text-sm text-gray-700">HP Construction Viet Nam</span>
              </div>
            </div>
            <button onClick={() => setShowForgot(false)}
