    ...
    <div className="space-y-6">
      <div className="flex items-center justify-between">
        <div>
          ...
          <p className="text-gray-500 mt-1 text-sm">Theo doi ton kho theo cong trinh va vat tu</p>
          {selectedCT
      ...
      <div className="grid grid-cols-3 gap-4">
        ...
        <div className="bg-white rounded-xl border border-gray-100 p-4 flex items-center gap-3">
          ...
          <div>
            ...
            <div className="text-sm text-gray-500">Con hang trong kho</div>
          </div>
        </div>
        <div className="bg-white rounded-xl border border-gray-100 p-4 flex items-center gap-3 cursor-pointer hover:border-red-200 transition-colors"
          ...
          <div>
            ...
            <div className="text-sm text-gray-500">Het hang / can kiem tra</div>
          </div>
        </div>
      </div>
      ...
      <div className="bg-white rounded-xl shadow-sm border border-gray-100 p-4 flex gap-3 flex-wrap items-center">
        <div className="relative flex-1 min-w-[200px]">
          ...
          <input value={search} onChange={e => setSearch(e.target.value)}
            placeholder="Tim ten hang hoa, nhom..."
          ...
          <table className="w-full text-sm">
            <thead className="bg-gray-50 border-b border-gray-100">
              <tr>
                ...
                <th className="text-center px-4 py-3 text-gray-500 font-medium">Trang thai</th>
              </tr>
            </thead>
            <tbody>
              {loading
                ? <tr><td colSpan={9} className="py-10 text-center text-gray-400">Dang tai du lieu...</td></tr>
                : filtered.length === 0
                  ? <tr><td colSpan={9} className="py-10 text-center text-gray-400">Khong co du lieu ton kho</td></tr>
                  : filtered.map((r, i) => {
