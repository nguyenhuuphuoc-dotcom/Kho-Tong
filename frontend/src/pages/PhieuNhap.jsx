                        ...
                        <tbody>
                          {items.map((it, i) => (
                            <tr key={i} className="border-t border-gray-100">
                              ...
                              <td className="px-1 py-1"><input value={it.ten_hang} onChange={e => updateItem(i, 'ten_hang', e.target.value)} placeholder="Ten vat tu..." className="w-full px-2 py-1.5 border border-gray-200 rounded text-xs focus:outline-none focus:border-blue-300" /></td>
