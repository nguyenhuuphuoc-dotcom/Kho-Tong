...
import { Upload, Search, RefreshCw, Eye, X, Plus, Trash2 } from 'lucide-react'
          ...
          <div className="bg-white rounded-xl shadow-xl w-full max-w-3xl max-h-[90vh] flex flex-col">
                        ...
                        <tr key={i} className="border-t border-gray-100">
                          ...
                          <td className="px-1 py-1">
                            <input type="number" value={it.so_luong} min="0" onChange={e => updateItem(i, 'so_luong', e.target.value)}
                              className="w-full px-2 py-1.5 border border-gray-200 rounded text-xs text-right focus:outline-none focus:border-orange-300" />
                          </td>
                          <td className="px-1 py-1">
            ...
            <div className="p-4 border-t bg-gray-50 flex items-center justify-between">
              <div>
                ...
                <p className="text-base font-bold text-orange-700">Tong: {formatVND(tongItems)}</p>
              </div>
              <div className="flex gap-2">
                ...
                <button onClick={handleCreate} disabled={creating}
                  className="px-5 py-2 bg-orange-500 hover:bg-orange-600 text-white rounded-lg text-sm font-medium disabled:opacity-50">
